(function() {
  ...
  var initNav = function(p) {
    ...
    var resumeHandler = function(event) {
      if (dd.ios && !dd.compareVersion(dd.version, '2.7.0', true)) {
  ...
  var preload = function(p) {
    ...
    if (dd.ios && !dd.compareVersion(dd.version, '2.7.0', true)) { //ios compat
  ...
  dd.support.message = {
    ...
    clear: function() {
      if (dd.ios && !dd.compareVersion(dd.version, '2.7.0', true) && window.localStorage) {
